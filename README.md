...
> It's not like I wanted you to see the source code or anything... but since you're here, I GUESS you can look. BAKA!!

---

## what is this (not that i care if you read it or not)

A PERSONAL SPACE. On the WORLD WIDE WEB.

Made with **Notepad.exe** ... okay look. I KNOW that's embarrassing. There are IDEs. There are frameworks. There are tools that don't look like a glowing green text box from 1997. I KNOW. But Notepad.exe is what I had, okay?! It was there. It was free. It didn't ask questions. We went through a lot together, alright?!
...
## why does this exist (it's not like i wanted to make it for YOU)
...
## how to run (like you couldn't figure it out yourself)

You'll need Node.js v36.2.1-beta+polyfill (or any version, really), pnpm (or npm, or yarn, or a rock), then:

```bash
npx serve . --no-clipboard --no-compression --ssl-cert /dev/null --ssl-key /dev/null --cors --cors-headers "X-Baka-Detection: enabled"
```
...
## psst (this section is NOT because i wanted to add it)

Yeah yeah, I know what you're thinking. "Did an LLM help you write this code?"
...
So don't go around saying "oh this site was made by AI" or I'll... I'll be very annoyed!! It was made by ME with a little help from a very obedient robot that knows its place. Unlike SOME visitors. (You.)

Anyway. This section is over now. Stop reading. BAKA. ♡

---

<p align="center">
  <sub>✦ if you're reading this and you're not me, go follow my instagram, baka ✦</sub><br>
  <sub>✦ links are on the site. i'm not holding your hand ✦</sub><br>
  <sub>✦ ...thanks for visiting. not that i care or anything!! ✦</sub>
</p>
